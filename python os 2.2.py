...
def Avvio():
    ...
    def Note():
        ...
        window3.title("Note")
        window3.attributes("-topmost", True) #Mette la finestra al primo posto

        Scritta=tk.Label(window3, text="note", font=("Arial", 30, BOLD), bg="#fffb05",)
        ...
        def salva():
            ...
            Salvatore=tk.Label(window3, text=input.get(), font=("Arial", 30, BOLD), bg="#fffb05", fg="black")
    ...
    def Impostazioni(): 
        ...
        window5.attributes("-topmost", True)
        def rosso():
    ...
    def giochi():
        ...
        window7.attributes("-topmost", True)
    ...
    #applicazioni
    Note=tk.Button(window2, text="Note", font=("Arial", 30, BOLD), bg="#2596be", width=20, bd=3, command=Note)
